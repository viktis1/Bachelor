...
# Channel 0 
dow -force -data iq_sequence_Hadamard_CH1.bin 0xA0900000 
# Channel 1 
dow -force -data iq_sequence_Hadamard_CH2.bin 0xA0904000 
# Channel 2 
dow -force -data iq_sequence_Hadamard_CH3.bin 0xA0908000 
# Channel 3 
dow -force -data iq_sequence_Hadamard_CH4.bin 0xA090C000 
# Channel 4 
dow -force -data iq_sequence_Hadamard_CH5.bin 0xA0910000 
# Channel 5 
dow -force -data iq_sequence_Hadamard_CH6.bin 0xA0914000 
# Channel 6 
dow -force -data iq_sequence_Hadamard_CH7.bin 0xA0918000 
# Channel 7 
dow -force -data iq_sequence_Hadamard_CH8.bin 0xA091C000 
...
mwr -force 0xA0045000 76 
mwr -force 0xA0045008 1965 
