...
# Channel 0 
dow -force -data iq_sequence_SIMO.bin 0xA0900000 
# Channel 1 
dow -force -data iq_sequence_SIMO.bin 0xA0904000 
# Channel 2 
dow -force -data iq_sequence_SIMO.bin 0xA0908000 
# Channel 3 
dow -force -data iq_sequence_SIMO.bin 0xA090C000 
# Channel 4 
dow -force -data iq_sequence_SIMO.bin 0xA0910000 
# Channel 5 
dow -force -data iq_sequence_SIMO.bin 0xA0914000 
# Channel 6 
dow -force -data iq_sequence_SIMO.bin 0xA0918000 
# Channel 7 
dow -force -data iq_sequence_SIMO.bin 0xA091C000 
